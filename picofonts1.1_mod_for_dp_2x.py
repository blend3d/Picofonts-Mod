# Modified to run on the Display Pack 2 & 2.8 from Pimoroni
# David W. 2025
'''
...
'''
# import picographics as display
...
#display one uppercase char at a time, like an old serial term...
test3uc = 'ABCDEFGHIJK'
display.set_pen(BLUE)
printstring(test3uc,0,60,2,True,False)

#display one uppercase char at a time, like an old serial term...
test4_uc = 'LMNOPQRSTUVWXYZ'
display.set_pen(BLUE)
printstring(test4_uc,0,80,2,True,False)

#display one char at a time, like an old serial term...
test3 = 'abcdefghijk'
display.set_pen(BLUE)
printstring(test3,0,120,2,True,False)

#display one char at a time, like an old serial term...
test4 = 'lmnopqrstuvwxyz'
display.set_pen(BLUE)
printstring(test4,0,140,2,True,False)

#display blocks of text fast
test5 = '`~!@#$%^&*()_-+=['
printstring(test5,0,160,2,False,False)
test6 = ']\\{}|;\':"<>?,./'
printstring(test6,0,180,2,False,False)
display.update()
